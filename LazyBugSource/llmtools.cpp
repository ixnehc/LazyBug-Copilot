...
// 	AddToolPara_Integer("maxResults", "Maximum number of results to return (default: 100)", false);
	...
	AppendToolDesc(" Currently supports image formats: jpg, jpeg, png, webp, bmp, gif, tiff, ico, dds, tga.");
//	AppendToolDesc(" (Video support planned for future extension: mp4, avi, mkv, mov, webm)");
	...
	AddToolPara_Integer("maxHeight", "Maximum height of the read image (default: 256). Only effective when maxWidth is also specified.", false);
	EndTool();
