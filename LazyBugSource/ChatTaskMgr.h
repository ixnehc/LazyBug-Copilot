...
public:
	...
	void _SendToolCallMessage_AddMcpServer(const char* result, bool addOp = true);
...
public:
	...
	void AddTask_HistoryEmbeddingQuery(const std::string& apiName, const std::string& embeddingApiName);
