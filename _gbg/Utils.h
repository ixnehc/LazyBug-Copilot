...
extern std::string FindNewestChatFile(const char* folder);
...
extern void DumpFindInFileResult(const char *key, FindInFileResults& results,std::string &resultString, int maxResult);
...
extern const char* GetDBRootFolder();
