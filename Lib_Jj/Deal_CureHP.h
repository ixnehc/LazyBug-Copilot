...
class Deal_CureHP:public CLevelDeal
{
public:
	DEFINE_CLASS(Deal_CureHP);


	BEGIN_GOBJ_PURE(Deal_CureHP,1);

		GELEM_VAR_INIT(BOOL,_bMaxHP,FALSE);
			GELEM_EDITVAR("回复HP最大值",GVT_S,GSem_Boolean,"是否回复HP最大值");
