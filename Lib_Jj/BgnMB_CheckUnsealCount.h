...
class CBgpMB_CheckUnsealCount:public CBehaviorGraphPad
{
	DEFINE_CLASS(CBgpMB_CheckUnsealCount);

	virtual const char *GetTypeName()	{		return "检查翻开格子数量";	}
    ...
    BEGIN_GOBJ_PURE(CBgpMB_CheckUnsealCount,1);
...
class CBgnMB_CheckUnsealCount:public CLevelBgn
{
public:
	DEFINE_CLASS(CBgnMB_CheckUnsealCount);
