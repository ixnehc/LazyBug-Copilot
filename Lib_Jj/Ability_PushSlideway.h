...
class CUpgradePushSlideway_Init:public CLevelAbilityInitial
{
public:
	DEFINE_ABILITY_UPGRADE_CLASS(CUpgradePushSlideway_Init,LevelAbilityType_PushSlideway);

	BEGIN_GOBJ_PURE(CUpgradePushSlideway_Init,1);
...
class CLevelAbility_PushSlideway:public CLevelAbility
{
	DEFINE_ABILITY_CLASS_WITH_INIITIAL_UPGRADE(CLevelAbility_PushSlideway,CUpgradePushSlideway_Init,LevelAbilityType_PushSlideway);

	BEGIN_GOBJ_PURE_UID2(CLevelAbility_PushSlideway,468,1);
