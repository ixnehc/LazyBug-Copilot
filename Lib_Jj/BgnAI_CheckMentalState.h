...
class CBgpAI_CheckMentalState:public CBehaviorGraphPad
{
public:
	DEFINE_CLASS(CBgpAI_CheckMentalState);

	virtual const char *GetTypeName()	{		return "检测MentalState";	}
    ...
    BEGIN_GOBJ_PURE_UID(CBgpAI_CheckMentalState,1);
		GELEM_BGP_BASE();
...
class CBgnAI_CheckMentalState:public CLevelBgn
{
public:
	DEFINE_CLASS(CBgnAI_CheckMentalState);
