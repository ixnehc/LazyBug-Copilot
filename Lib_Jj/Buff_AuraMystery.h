...
struct BuffParam_AuraMystery:public LevelBuffParam
{
	DEFINE_BUFFPARAM_CLASS(BuffParam_AuraMystery);

	BEGIN_GOBJ_PURE(BuffParam_AuraMystery,1);
...
struct BuffArg_AuraMystery
{
	DEFINE_CLASS(BuffArg_AuraMystery)
};


class Buff_AuraMystery:public CLevelBuff
{
public:
	DEFINE_BUFF_CLASS(Buff_AuraMystery,56)
