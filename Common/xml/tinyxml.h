...
class TiXmlBase
{
  ...
  public:
	...
	*/
	...
	virtual void PrintToString( std::string &s, int depth )	= 0;
...
class TiXmlNode : public TiXmlBase
{
  public:
	...
	*/
	...
	TiXmlCData*	   ToCData()    const	{ return ( type == CDATA    ) ? (TiXmlCData*)    this : 0; } ///< Cast to a more defined type. Will return null not of the requested type.
...
class TiXmlAttribute : public TiXmlBase
{
  ...
  public:
	...
	*/	
	...
	// [internal use] 
	virtual void PrintToString( std::string &s, int depth );
...
class TiXmlComment : public TiXmlNode
{
  public:
	...
	TiXmlComment( const std::string& _value ) : TiXmlNode( TiXmlNode::COMMENT ) { value = _value; }
...
class TiXmlText : public TiXmlNode
{
  public:
	...
	TiXmlText( const std::string& _value ) : TiXmlNode( TiXmlNode::TEXT ) { value = _value; }
	virtual ~TiXmlText() {}
...
{
  public:
	TiXmlCData()  : TiXmlNode( TiXmlNode::CDATA ) {}
	TiXmlCData( const std::string& _value ) : TiXmlNode( TiXmlNode::CDATA ) { value = _value; }
	virtual ~TiXmlCData() {}
...
class TiXmlDocument : public TiXmlNode
{
  public:
	...
	*/
	...
	//Load from raw data	
	bool LoadRawData(unsigned char*pData);
