...
public:
	...
	inline float getAreaCost(const int i) const { return 1.0f; }
...
public:
	...
	dtStatus init(dtMeshBase* nav, int maxNodes);
	...
	void switchWalkable(dtPolyRef *refs,int count, bool isOn);
	
	class dtNodePool* getNodePool() const { return m_nodePool; }
	
	const dtMeshBase * getAttachedNavMesh() const { return m_nav; }
...
private:
	...
	dtMeshBase* m_nav;				///< Pointer to navmesh data.
