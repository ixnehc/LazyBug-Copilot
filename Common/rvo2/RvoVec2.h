...
public:
	 ...
	 *             to (0.0, 0.0).
	 */
	inline RvoVec2() : x_(0.0f), y_(0.0f) { }
	 ...
	 *                             vector.
	 */
	inline RvoVec2(float x, float y) : x_(x), y_(y) { }
	 ...
	 */
	inline RvoVec2 operator-() const
	{
		return RvoVec2(-x_, -y_);
	}
	 ...
	 */
	inline float operator*(const RvoVec2 &vector) const
	{
	 ...
	 */
	inline RvoVec2 operator*(float s) const
	{
		return RvoVec2(x_ * s, y_ * s);
	}
	...
	inline RvoVec2 operator/(float s) const
	{
		...
		return RvoVec2(x_ * invS, y_ * invS);
	}
	 ...
	 *             specified two-dimensional vector.
	 */
	inline RvoVec2 operator+(const RvoVec2 &vector) const
	{
		return RvoVec2(x_ + vector.x(), y_ + vector.y());
	}
	 ...
	 */
	inline bool operator==(const RvoVec2 &vector) const
	{
		return x_ == vector.x() && y_ == vector.y();
	}
	 ...
	 */
	inline RvoVec2 &operator*=(float s)
	{
		x_ *= s;
		y_ *= s;
	 ...
	 * \return     A reference to this two-dimensional vector.
	 */
	inline RvoVec2 &operator+=(const RvoVec2 &vector)
	{
		x_ += vector.x();
		y_ += vector.y();
 ...
 *             scalar value.
 */
inline RvoVec2 operator*(float s, const RvoVec2 &vector)
{
	return RvoVec2(s * vector.x(), s * vector.y());
}
 ...
 */
inline std::ostream &operator<<(std::ostream &os, const RvoVec2 &vector)
{
 ...
 */
inline float abs(const RvoVec2 &vector)
{
	return std::sqrtf(vector * vector);
}
 ...
 */
inline float absSq(const RvoVec2 &vector)
{
 ...
 */
inline float det(const RvoVec2 &vector1, const RvoVec2 &vector2)
{
 ...
 */
inline RvoVec2 normalize(const RvoVec2 &vector)
{
