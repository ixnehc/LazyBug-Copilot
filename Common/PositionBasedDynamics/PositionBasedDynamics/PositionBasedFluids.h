	...
	public:
		...
		*/	
		static bool computePBFDensity(
			...
			const i_math::vector3df x[],						// array of all particle positions
			const Real mass[],								// array of all particle masses
			const i_math::vector3df boundaryX[],				// array of all boundary particles
		...
		*/
		static bool solveDensityConstraint(
			...
			i_math::vector3df &corr);							// returns the position correction for the current fluid particle
	};
}
