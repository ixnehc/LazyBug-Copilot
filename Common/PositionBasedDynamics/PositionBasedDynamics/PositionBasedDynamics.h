	...
	public:
		...
		*/
		...
		static bool solve_DihedralConstraint(
			const i_math::vector3df &p0, Real invMass0,		// angle on (p2, p3) between triangles (p0, p2, p3) and (p1, p3, p2)
			const i_math::vector3df &p1, Real invMass1,
		...
		static bool solve_BendConstraint(
			const i_math::vector3df &p0, Real invMass0,
			const i_math::vector3df &p1, Real invMass1,
			const i_math::vector3df &p2, Real invMass2,
...
// 			const i_math::vector3df x0[], const Real invMasses[], const int numPoints,
...
// 			const i_math::vector3df x0[], const i_math::vector3df x[], const Real invMasses[], const int numPoints,
// 			const i_math::vector3df &restCm, 
// 			const Matrix3r &invRestMat,
// 			const Real stiffness,
// 			const bool allowStretch,		// default false
// 			i_math::vector3df corr[], Matrix3r *rot = NULL);
...
// 			const i_math::vector3df &p3, Real invMass3,
// 			const Matrix3r &invRestMat,
// 			const i_math::vector3df &stretchStiffness,			// xx, yy, zz
// 			const i_math::vector3df &shearStiffness,			// xy, xz, yz
// 			const bool normalizeStretch,		// use false as default
// 			const bool normalizeShear,		// use false as default
// 			i_math::vector3df &corr0, i_math::vector3df &corr1, i_math::vector3df &corr2, i_math::vector3df &corr3);
