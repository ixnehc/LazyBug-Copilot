...
namespace PBD
{
	...
	private:
		...
		*/
		static bool computeDarbouxVector(
			...
			i_math::vector3df & darbouxVector
			);
	...
	public:
		...
		* @param q0 i_math::quatf at the center of the edge
	...
	public:
		...
		*/
		static bool solve_DarbouxVectorConstraint(
			...
			const i_math::vector3df& restDarbouxVector,
			i_math::vector3df& oa, i_math::vector3df&  ob, i_math::vector3df&  oc, i_math::vector3df&  od, i_math::vector3df& oe);
		
		/** Computes the material frame (eq. 3 in the paper)
		*/
		static bool computeMaterialFrame(
			const i_math::vector3df& p0, //1st centreline point id
			const i_math::vector3df& p1, //2nd centreline point id
			const i_math::vector3df& p2, //corresponding ghost point
		...
		*/
		static bool computeDarbouxVector(
			...
			i_math::vector3df& darboux_vector); //resulting darboux vector
		
		/** Computes the material frame derivatives (eq. 43, 44 and 45 in the appendix)
		*/
		static bool computeMaterialFrameDerivative(
			const i_math::vector3df& p0, const i_math::vector3df& p1, const i_math::vector3df& p2, // points
		...
		*/
		static bool computeDarbouxGradient(
			const i_math::vector3df& darboux_vector, //Darboux vector
			const Real length, //element length
			const Matrix3r& dA, //1st material frame
			const Matrix3r& dB, //2nd material frame
			const Matrix3r[3][3], const Matrix3r[3][3], //material frames derivatives
			//const i_math::vector3df& bendAndTwistKs, //bending (x,y) and twisting (z) stiffness
