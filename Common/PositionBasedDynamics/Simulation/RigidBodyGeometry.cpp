...
void RigidBodyGeometry::initMesh(const unsigned int nVertices, const unsigned int nFaces, const i_math::vector3df *vertices, const unsigned int* indices, const Mesh::UVIndices& uvIndices, const Mesh::UVs& uvs, const i_math::vector3df &scale)
{
	m_mesh.release();
...
void RigidBodyGeometry::updateMeshTransformation(const i_math::vector3df &x, const Matrix3r &R)
{
