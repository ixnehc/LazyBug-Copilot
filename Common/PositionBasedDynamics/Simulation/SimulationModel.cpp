...
// 	}
	...
	{
		const i_math::vector3df& x0 = m_particles.getPosition0(i);
	...
	{
		const i_math::quatf& q0 = m_orientations.getQuaternion0(i);
...
SimulationModel::SimpleContactConstraintVector &SimulationModel::getSimpleConstactConstraintVector()
{
	return m_simpleContactConstraints;
}
...
// bool SimulationModel::addBallJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos)
// {
...
// }
// 
// bool SimulationModel::addBallOnLineJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &dir)
// {
...
// }
// 
// bool SimulationModel::addHingeJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis)
// {
...
// }
// 
// bool SimulationModel::addUniversalJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis1, const i_math::vector3df &axis2)
// {
...
// }
// 
// bool SimulationModel::addSliderJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis)
// {
...
// }
// 
// bool SimulationModel::addTargetPositionMotorSliderJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis)
// {
...
// }
// 
// bool SimulationModel::addTargetVelocityMotorSliderJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis)
// {
...
// 
// 
// bool SimulationModel::addTargetAngleMotorHingeJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis)
// {
...
// }
// 
// bool SimulationModel::addTargetVelocityMotorHingeJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis)
// {
...
// }
// 
// bool SimulationModel::addDamperJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis, const Real stiffness)
// {
...
// }
// 
// bool SimulationModel::addRigidBodySpring(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos1, const i_math::vector3df &pos2, const Real stiffness)
// {
...
// }
// 
// bool SimulationModel::addDistanceJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos1, const i_math::vector3df &pos2)
// {
...
bool SimulationModel::addSimpleContactConstraint(const unsigned int particle1, const unsigned int particle2,float minLength)
{
	SimpleContactConstraint *c = new SimpleContactConstraint();
	const bool res = c->initConstraint(*this, particle1, particle2,minLength);
	if (res)
	{
		m_simpleContactConstraints.push_back(c);
	}
	return res;
}

void SimulationModel::removeConstraint(int iConstraint)
{
	if (((DWORD)iConstraint)<m_constraints.size())
	{
		delete m_constraints[iConstraint];
		m_constraints[iConstraint]=NULL;

		m_constraintsFreeList.push_back(iConstraint);
...
int SimulationModel::addConstraint(Constraint *c,int iConstraint)
{
	int idxConstraint=-1;
	if (iConstraint==-1)
	{
		if (m_constraintsFreeList.size()>0)
		{
			idxConstraint=m_constraintsFreeList[0];
			m_constraintsFreeList.pop_front();
			m_constraints[idxConstraint]=c;
		}
		else
		{
			idxConstraint=m_constraints.size();
	...
	{
		delete m_constraints[iConstraint];
		m_constraints[iConstraint]=c;
		idxConstraint=iConstraint;
	}
	m_groupsInitialized = false;
...
int SimulationModel::addDistanceConstraint(const unsigned int particle1, const unsigned int particle2,float stiffness,float length,int iConstraint)
{
	DistanceConstraint *c = new DistanceConstraint();
	const bool res = c->initConstraint(*this, particle1, particle2,length,stiffness);
	if (res)
		return addConstraint(c,iConstraint);
	return -1;
}


int SimulationModel::addBendConstraint(const unsigned int particle1, const unsigned int particle2,const unsigned int particle3,
									   i_math::vector3df &dirDef,
									   float toleranceAngle,float lengthMax,int iConstraint)
{
	BendConstraint *c = new BendConstraint();
	const bool res = c->initConstraint(*this, particle1, particle2, particle3,dirDef,toleranceAngle,lengthMax);
	if (res)
		return addConstraint(c,iConstraint);
	return -1;
}

int SimulationModel::addPullConstraint(const unsigned int particle1, const unsigned int particle2,
									   float length,float minStiffness,float maxStiffness,i_math::vector3df &dir,int iConstraint)
{
	PullConstraint *c = new PullConstraint();
	const bool res = c->initConstraint(*this, particle1, particle2, length,minStiffness,maxStiffness,dir);
	if (res)
		return addConstraint(c,iConstraint);
	return -1;
}
...
// 	const std::vector<i_math::vector3df> &jointPositions,
...
//	const unsigned int numRigidBodies = (unsigned int) m_rigidBodies.size();
	const unsigned int numRigidBodies = 0;
...
// 	m_particleSolidContactConstraints.clear();
	...
	for (unsigned int i = 0; i < m_simpleContactConstraints.size(); i++)
		delete m_simpleContactConstraints[i];
	m_simpleContactConstraints.clear();
