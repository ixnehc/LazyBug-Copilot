...
{	
	class RigidBodyGeometry
	{
		...
		public:
			...
			void initMesh(const unsigned int nVertices, const unsigned int nFaces, const i_math::vector3df *vertices, const unsigned int* indices, const Mesh::UVIndices& uvIndices, const Mesh::UVs& uvs, const i_math::vector3df &scale = i_math::vector3df(1.0, 1.0, 1.0));
			void updateMeshTransformation(const i_math::vector3df &x, const Matrix3r &R);
