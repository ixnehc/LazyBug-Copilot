...
{	
	...
	class SimulationModel 
	{
		...
		public:
			...
			typedef std::vector<SimpleContactConstraint*> SimpleContactConstraintVector;
...
// 			TetModelVector m_tetModels;
			...
			std::deque<int> m_constraintsFreeList;
			SimpleContactConstraintVector m_simpleContactConstraints;
...
// 			TetModelVector &getTetModels();
			...
			SimpleContactConstraintVector &getSimpleConstactConstraintVector();
...
// 			bool addBallJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos);
// 			bool addBallOnLineJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &dir);
// 			bool addHingeJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis);
// 			bool addTargetAngleMotorHingeJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis);
// 			bool addTargetVelocityMotorHingeJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis);
// 			bool addUniversalJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const i_math::vector3df &axis1, const i_math::vector3df &axis2);
// 			bool addSliderJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis);
// 			bool addTargetPositionMotorSliderJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis);
// 			bool addTargetVelocityMotorSliderJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis);
// 			bool addRigidBodyParticleBallJoint(const unsigned int rbIndex, const unsigned int particleIndex);
// 			bool addRigidBodySpring(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos1, const i_math::vector3df &pos2, const Real stiffness);
// 			bool addDistanceJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos1, const i_math::vector3df &pos2);
// 			bool addDamperJoint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &axis, const Real stiffness);
...
// 				const Real restitutionCoeff, const Real frictionCoeff);
			...
			bool addSimpleContactConstraint(const unsigned int particle1, const unsigned int particle2,float minLength);

			void removeConstraint(int iConstraint);
			int addConstraint(Constraint *c,int iConstraint);

			int addDistanceConstraint(const unsigned int particle1, const unsigned int particle2,float stiffness,float length=-1.0f,int iConstraint=-1);
			int addBendConstraint(	const unsigned int particle1, const unsigned int particle2,const unsigned int particle3,i_math::vector3df &dirDef,float toleranceAngle,float lengthMax,int iConstraint=-1);
			int addPullConstraint(const unsigned int particle1, const unsigned int particle2,float length,float minStiffness,float maxStiffness,i_math::vector3df &dir,int iConstraint=-1);
...
// 			bool addStretchBendingTwistingConstraint(const unsigned int rbIndex1, const unsigned int rbIndex2, const i_math::vector3df &pos, const Real averageRadius, const Real averageSegmentLength, const Real youngsModulus, const Real torsionModulus);
// 			bool addDirectPositionBasedSolverForStiffRodsConstraint(const std::vector<std::pair<unsigned int, unsigned int>> & jointSegmentIndices, const std::vector<i_math::vector3df> &jointPositions, const std::vector<Real> &averageRadii, const std::vector<Real> &averageSegmentLengths, const std::vector<Real> &youngsModuli, const std::vector<Real> &torsionModuli);
