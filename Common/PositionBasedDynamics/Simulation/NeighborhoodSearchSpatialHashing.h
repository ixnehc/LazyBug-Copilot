...
namespace PBD
{
	...
	public: 
		...
		void cleanup();
		void neighborhoodSearch(i_math::vector3df *x);
		void neighborhoodSearch(i_math::vector3df *x, const unsigned int numBoundaryParticles, i_math::vector3df *boundaryX);
		void update();
