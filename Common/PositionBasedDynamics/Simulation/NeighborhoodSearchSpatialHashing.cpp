...
void NeighborhoodSearchSpatialHashing::neighborhoodSearch(i_math::vector3df *x) 
{		
...
void NeighborhoodSearchSpatialHashing::neighborhoodSearch(i_math::vector3df *x, const unsigned int numBoundaryParticles, i_math::vector3df *boundaryX)
{		
	const Real factor = static_cast<Real>(1.0)/m_cellGridSize;
	for (int i=0; i < (int) m_numParticles; i++)
	{
