...
// using i_math::vector2df = Eigen::Matrix<Real, 2, 1, Eigen::DontAlign>;
// using i_math::vector3df = Eigen::Matrix<Real, 3, 1, Eigen::DontAlign>;
...
// using i_math::matrix44f = Eigen::Matrix<Real, 4, 4, Eigen::DontAlign>;
...
// using i_math::quatf = Eigen::Quaternion<Real, Eigen::DontAlign>;
